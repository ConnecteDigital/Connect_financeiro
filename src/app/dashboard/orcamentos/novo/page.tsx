    ...
    <div className="space-y-5 max-w-3xl mx-auto">
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm" style={{ color: 'var(--text-secondary)' }}>Preencha os dados do cliente e dos serviços</p>
        </div>
      </div>
      ...
      <div className="flex gap-3 justify-end pb-6">
        <Link href="/dashboard/orcamentos" className="px-5 py-2.5 rounded-xl text-sm font-medium transition"
